...
/*
 * adapted from Zend_Service_Amazon_Ec2_Response to remove dependencies with ec2
 * @see Zend_Service_Amazon_Ec2_Response
 */
class Livesourcing_Service_Amazon_SES_Response {
    /**
     * XML namespace used for SES responses.
     */
    ...
    /**
     * Creates a new high-level SES response object
     *
    ...
    public function getXPath()
    {
        if ($this->_xpath === null) {
            ...
            if ($document === false) {
                ...
                $this->_xpath->registerNamespace('ses',
                    $this->getNamespace());
            }
        }
